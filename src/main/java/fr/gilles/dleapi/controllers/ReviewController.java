...
import fr.gilles.dleapi.services.rating.ReviewService;
...
public class ReviewController {
    ...
    public ResponseEntity<Review> create(@PathVariable @NotNull @NotBlank @NotEmpty String productCode, Authentication authentication) {
        Optional<Product> product = productService.find(productCode);
